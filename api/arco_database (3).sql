...
--
-- Host: 127.0.0.1
-- Generation Time: May 23, 2024 at 02:45 AM
...
(16, 'try', '2024-05-22', 'try', 'try', 347, 82, 'jkfheri', 2, '2024-05-22 08:11:05', '2024-05-22 08:11:05'),
(17, 'Arco Financial Report ', '2024-12-02', 'Arco Final Report', 'ksfsdhfshkhf', 2023, 12355, 'jkhksdhfskdf', 2, '2024-05-22 10:25:21', '2024-05-22 10:25:21'),
(18, 'Event Report', '2024-12-02', 'Arco event', 'khfdi', 83248, 9324, 'dnfksndgkn', 2, '2024-05-22 10:32:23', '2024-05-22 10:32:23');
...
(112, 'redanicas', 'readanicas@gmail.com', '$2y$10$C24dCN0OqArdcPp7bMJmTO8iKvgcGsAHj4fi8kIAbKI');
...
--
ALTER TABLE `annualreports`
  MODIFY `report_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `collage`
--
ALTER TABLE `collage`
  MODIFY `collage_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=88;
...
--
ALTER TABLE `eventreports`
  MODIFY `event_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `financialreports`
--
ALTER TABLE `financialreports`
  MODIFY `financialreport_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
